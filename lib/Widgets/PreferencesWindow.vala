...
namespace Plank
{
	...
	public class PreferencesWindow : Gtk.Window
	{
		...
		[GtkChild]
		unowned Gtk.Switch sw_background_glow;
		...
		void prefs_changed (Object o, ParamSpec prop)
		{
			...
			case "BackgroundGlowEnabled":
				sw_background_glow.set_active (prefs.BackgroundGlowEnabled);
				break;
			// Ignored settings
			case "DockItems":
				break;
		...
		void background_glow_toggled (GLib.Object widget, ParamSpec param)
		{
			prefs.BackgroundGlowEnabled = ((Gtk.Switch) widget).get_active ();
		}
		...
		void connect_signals ()
		{
			...
			sw_background_glow.notify["active"].connect (background_glow_toggled);
		...
		void disconnect_signals ()
		{
			...
			sw_background_glow.notify["active"].disconnect (background_glow_toggled);
